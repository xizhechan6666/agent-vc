...
def generate_interview(project: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "questions": [
            {
                "id": "q1",
                "question": "这个 Agent 为谁解决什么问题，为什么愿意付费而不是直接用通用大模型或现成 Agent？",
                "why_it_matters": "这是判断需求真实性、付费理由和替代风险的核心问题。",
            },
            {
                "id": "q2",
                "question": "请说清楚它怎么交付：用户从输入到拿到结果的流程、当前上线状态、可核验链接。",
                "why_it_matters": "这决定产品成熟度、交付稳定性和我们能否直接核验。",
            },
            {
                "id": "q3",
                "question": "请给出最强的验证材料：定价、使用、收入、试用、案例、链上或产品证据里最有力的 1-2 项。",
